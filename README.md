...
<form action="YOUR_DEPLOYMENT_URL" method="GET">
...
<body>
  ...
  <a href="YOUR_DEPLOYMENT_URL?action=click&email=${email}&redirect=https://yoursite.com/offers">
    View Offers
  </a>
  
  <!-- Open Tracking Pixel -->
  <img src="YOUR_DEPLOYMENT_URL?action=track&email=${email}&ts=TIMESTAMP" 
       width="1" height="1" style="display:none">
       
  <!-- Unsubscribe Link -->
  <p style="font-size: 12px;">
    <a href="YOUR_DEPLOYMENT_URL?action=unsubscribe&email=${email}">
      Unsubscribe
    </a>
  </p>
</body>
...
const API_BASE = 'YOUR_DEPLOYMENT_URL';
...
<a href="YOUR_DEPLOYMENT_URL?action=subscribe&email=user@example.com&name=Quick+Subscriber">
  Subscribe to Newsletter
</a>

<!-- Quick Unsubscribe Link -->
<a href="YOUR_DEPLOYMENT_URL?action=unsubscribe&email=user@example.com">
